...
excerpt: CRP is a marker of inflammation, but an elevated result is not a
  diagnosis on its own. Learn what a high CRP level may mean, when it can rise,
  and how it should be interpreted.
author: Dimitra M., BSc Biomedical Science
featured: false
seo_title: "High CRP: What Does It Mean, When Does It Rise, and How Can It Be Lowered?"
...
C-reactive protein (**CRP**) is one of the most commonly used laboratory markers of inflammation. An elevated level can indicate to a healthcare professional that an inflammatory process may be taking place somewhere in the body, but CRP cannot show **where the inflammation is located or what is causing it**.[4](https://www.medlineplus.gov/lab-tests/c-reactive-protein-crp-test/)

That is why CRP should never be interpreted in isolation.

## What Is CRP?

C-reactive protein is an **acute-phase protein** produced mainly by the liver. Its production increases during the inflammatory response, largely under the influence of signaling molecules such as **interleukin-6 (IL-6)**.[1](https://pubmed.ncbi.nlm.nih.gov/2464504/)

CRP is not simply a passive laboratory marker. It can bind to certain components of microorganisms or damaged cells and interact with the *complement system*, contributing to mechanisms involved in innate immune defense and phagocytosis.[3](https://nyaspubs.onlinelibrary.wiley.com/doi/abs/10.1111/j.1749-6632.1982.tb22141.x)
...
Studies of CRP metabolism in humans have shown that its *plasma half-life is approximately 19 hours*. Its clearance remains relatively constant, meaning that major changes in blood CRP levels mainly reflect changes in the rate at which the body is producing it.[2](https://www.jci.org/articles/view/116336)

This helps explain why CRP can be useful for monitoring an inflammatory process over time.

If the trigger causing inflammation persists, CRP may remain elevated. If the underlying inflammation resolves, CRP levels usually fall as well.[2](https://www.jci.org/articles/view/116336) [4](https://www.medlineplus.gov/lab-tests/c-reactive-protein-crp-test/)
...
- how serious a condition is based on the CRP value alone.[4](https://www.medlineplus.gov/lab-tests/c-reactive-protein-crp-test/)

A CRP result therefore becomes clinically meaningful only when it is interpreted together with a person's *symptoms, medical history, physical examination* and, when appropriate, other laboratory or imaging tests.[4](https://www.medlineplus.gov/lab-tests/c-reactive-protein-crp-test/)
...
Both bacterial and viral infections can trigger an inflammatory response and increase CRP levels.[4](https://www.medlineplus.gov/lab-tests/c-reactive-protein-crp-test/)
...
- other autoimmune or inflammatory disorders.[4](https://www.medlineplus.gov/lab-tests/c-reactive-protein-crp-test/)
...
CRP may therefore rise after surgery, trauma, or other forms of tissue damage.[4](https://www.medlineplus.gov/lab-tests/c-reactive-protein-crp-test/)

### Chronic Low-Grade Inflammation

Not every increase in CRP is caused by an acute illness.

Higher CRP concentrations are more commonly observed in people with obesity and may also be associated with smoking and other chronic health factors.[4](https://www.medlineplus.gov/lab-tests/c-reactive-protein-crp-test/) [5](https://pubmed.ncbi.nlm.nih.gov/15051595/) [8](https://www.nature.com/articles/s41598-018-29867-9) [10](https://diabetesjournals.org/care/article/33/11/2297/26369/A-1-Year-Lifestyle-Intervention-for-Weight-Loss-in)
...
A standard CRP test is generally used when clinicians are assessing or monitoring an inflammatory condition. The hs-CRP test can detect much lower CRP concentrations and is used in selected situations as an aid in assessing **cardiovascular risk**.[4](https://www.medlineplus.gov/lab-tests/c-reactive-protein-crp-test/)
...
If CRP is elevated because of an infection, treating the infection may cause it to fall. If it is elevated because of an inflammatory disease, controlling the disease may lower CRP. If it increased after an injury or surgery, it may decline as healing progresses.[4](https://www.medlineplus.gov/lab-tests/c-reactive-protein-crp-test/)
...
Randomized lifestyle intervention trials have shown that weight-loss interventions can reduce CRP in people with obesity or excess body weight.[5](https://pubmed.ncbi.nlm.nih.gov/15051595/) [10](https://diabetesjournals.org/care/article/33/11/2297/26369/A-1-Year-Lifestyle-Intervention-for-Weight-Loss-in)

For example, an 18-month randomized trial in older adults with overweight or obesity found that weight loss through dietary intervention reduced CRP and other markers of inflammation.[5](https://pubmed.ncbi.nlm.nih.gov/15051595/)

A large lifestyle intervention in people with obesity and type 2 diabetes also produced significant reductions in high-sensitivity CRP over one year.[10](https://diabetesjournals.org/care/article/33/11/2297/26369/A-1-Year-Lifestyle-Intervention-for-Weight-Loss-in)
...
In the randomized **INFLAME** trial, four months of aerobic exercise without meaningful weight loss did not significantly reduce CRP in sedentary individuals who already had elevated CRP levels at baseline.[6](https://pubmed.ncbi.nlm.nih.gov/19952828/)

Other lifestyle intervention studies suggest that reductions in body fat and broader improvements in metabolic health may partly explain why CRP sometimes decreases during exercise programs.[5](https://pubmed.ncbi.nlm.nih.gov/15051595/) [6](https://pubmed.ncbi.nlm.nih.gov/19952828/)
...
In a randomized trial, Mediterranean-style diets supplemented with either extra-virgin olive oil or nuts improved several cardiovascular risk factors, while CRP decreased in the group consuming olive oil compared with a control group following a low-fat diet.[7](https://pubmed.ncbi.nlm.nih.gov/16818923/)
...
Smoking is associated with chronic inflammation and higher CRP levels in many populations.[8](https://www.nature.com/articles/s41598-018-29867-9)

A prospective cohort study found that smoking cessation was associated with a favorable effect on CRP levels, although the change was not immediate.[8](https://www.nature.com/articles/s41598-018-29867-9)
...
In one randomized study, healthy volunteers who restricted their sleep to four hours per night for several days experienced changes in inflammatory markers.[9](https://pubmed.ncbi.nlm.nih.gov/17910386/)
